...
def welcome():
    ...
    # Create dictionary from the row data and append to a list called start_date_tobs
    start_date_tobs = []
...
@app.route("/api/v1.0/<start_date>/<end_date><br/")
def welcome():
    # Create session to database
    session = Session(engine)
    ...
    # repeat process in "/api/v1.0/<start_date><br/" for dictionary creation, calling the dict start_end_tobs this time
    start_end_tobs = []
    for min, avg, max in results:
        start_end_tobs_dict = {}
